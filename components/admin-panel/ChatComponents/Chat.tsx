...
const Chat = () => {
  ...
  return (
    <div className="min-w-screen fontchat flexCenter min-h-screen  gap-5 bg-slate-800 p-3">
      ...
      <div className="flex h-[850px] w-3/4 flex-col justify-end gap-3 rounded-xl bg-white p-3">
            ...
            data.map((namePerson: { id: number; messages: Tmessage[] }, i) => (
              <div
                className={`${classNames({
                  flex: namePerson.id === selectedPerson,
                  hidden: namePerson.id !== selectedPerson,
        ...
        <div
          ...
          })} ic-jc w-full flex-row-reverse gap-2`}>
